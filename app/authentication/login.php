...
<body>
    <main class="flex flex-col items-center justify-center h-screen">
        <h1 class="text-xl font-sans font-medium">Log In</h1>
        <form method="post" action="../includes/login.inc.php">
            <div class="w-96 p-6 rounded">
                <div class="flex flex-col items-center gap-6">
                    ...
                    <button type="submit" name="submitButton" class="w-50 hover:bg-indigo-900 hover:text-slate-100 border border-transparent rounded-xl pt-2 pb-2 pl-6 pr-6">Log In</button>
                </div>
            </div>
        </form>
